...
if(showNonBoBlattice):
    ...
    plt.scatter(runTimesArray,crashProbsArray,color='blue',marker='D')
...
if(showBaseline):
    ...
    plt.scatter(runTimesArray,crashProbsArray,color='purple',marker='s')
...
if(showRamneetKandN):
    ...
    plt.scatter(runTimesArray,crashProbsArray,color='brown',marker='*',s=130)
...
if(showOlegBaseline):
    ...
    plt.scatter(runTimesArray[:-2],crashProbsArray[:-2],color='green',marker='X')
...
if(showOlegBaselineWithRounding):
    ...
    plt.scatter(runTimesArray[:-2],crashProbsArray[:-2],color='red',marker='.',s=150)
