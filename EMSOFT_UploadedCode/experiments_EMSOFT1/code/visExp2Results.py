...
resultsFileCrashProbs = open('C:\\Users\\matth\\Documents\\Penn\\safetyContract\\experiments_NFM\\conservatismAnalysis\\results\\exp2\\exp2CrashProbsSpeed10.csv')
...
indLower = round((initDistLower-0.5)/distanceDisc)
