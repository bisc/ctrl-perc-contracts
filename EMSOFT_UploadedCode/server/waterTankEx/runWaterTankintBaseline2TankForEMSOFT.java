...
public class runWaterTankOlegBaseline2TankForEMSOFT {

	
	PrismConnectorAPI myPrismConnectorAPI;
	
	public runWaterTankOlegBaseline2TankForEMSOFT () throws PrismException {
	...
	public static void main (String[] args) throws Exception {
        ...
        String runTimeResults = resultsFolder + "runTimesTwoTankOlegBaseline.csv";
        PrintWriter runTimeWriter = new PrintWriter(runTimeResults);
        
        String crashProbResults = resultsFolder + "crashProbsTwoTankOlegBaseline.csv";
