...
%         fileName = sprintf('PRISMModels/ForPaper/windows/N5/diffDeltaDs/TTCThresh/latticePRISMModelTrimmedCondLECN5d075.prism');
%     end
    fileName = sprintf('PRISMModels/ForPaper/windows/N3H3L3/diffDeltaDsBoBLatticeInitCond2/latticePRISMModelTrimmedCondLECN3H3L3d%f.prism', deltad);
%     fileName = sprintf('PRISMModels/ForPaper/windows/N3H3L3AllVote/diffDeltaDsBoBLattice/unBoBLattice.prism');
