...
for latticeDistDisc in latticeDistDiscs:
    ...
    modelfile = open('latticeWindowedModels/windowedLattice-N' + str(N) + 'M' + str(M) + 'L' + str(L) + '-deltaD' + str(latticeDistDisc) + '.prism', 'w')
    # distIndUpper = 43
    # distIndLower = 43
    LECModelDistDisc = 10
    ...
    for binInd in range(len(probsHists)):
        ...
        for prevSIter in range(0,2**lookBackLen):
            ...
            if(lookBackLen==7):
                fileName = 'windowed/N' + str(N) + 'M' + str(M) + '/probsHot-N' + str(N) + '-M' + str(M) + '-L' + str(currHistLen) + '-init' + str(1-s7) + str(1-s6) + str(1-s5) + str(1-s4) + str(1-s3) + str(1-s2) + str(1-s1) + '.csv'
            if(lookBackLen==5):
                fileName = 'windowed/N' + str(N) + 'M' + str(M) + '/probsHot-N' + str(N) + '-M' + str(M) + '-L' + str(currHistLen) + '-init' + str(1-s5) + str(1-s4) + str(1-s3) + str(1-s2) + str(1-s1) + '.csv'
            if(lookBackLen==3):
                fileName = 'windowed/N' + str(N) + 'M' + str(M) + '/probsHot-N' + str(N) + '-M' + str(M) + '-L' + str(currHistLen) + '-init' + str(1-s3) + str(1-s2) + str(1-s1) + '.csv'
            if(lookBackLen==4):
                fileName = 'windowed/N' + str(N) + 'M' + str(M) + '/probsHot-N' + str(N) + '-M' + str(M) + '-L' + str(currHistLen) + '-init' + str(1-s4) + str(1-s3) + str(1-s2) + str(1-s1) + '.csv'
            if(lookBackLen==2):
                fileName = 'windowed/N' + str(N) + 'M' + str(M) + '/probsHot-N' + str(N) + '-M' + str(M) + '-L' + str(currHistLen) + '-init' + str(1-s3) + str(1-s2) + str(1-s1) + '.csv'
