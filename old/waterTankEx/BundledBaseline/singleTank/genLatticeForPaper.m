...
%% Add N transitions
N=1;
lattice = addOlegBaselineTransitions(baseline,N,deltawl,inflow,outflow,0);
...
convertOlegBaselineToPRISMModelCondLEC(lattice,N,'PRISMModels/testModel.prism',deltawl,1);
