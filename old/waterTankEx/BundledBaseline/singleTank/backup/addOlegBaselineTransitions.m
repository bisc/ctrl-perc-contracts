function [lattice] = addOlegBaselineTransitions(lattice,N,deltawl,inflow,outflow,rounding)
...
for i=1:latticeSize(2)
    ...
    clear newMapValue
    for K=0:1:N
        [nextwls] = computeOlegBaselineTransitionWaterTank(wl,K,deltawl,inflow,outflow,10);
        ...
        for iter = 1:length(nextwls)
            ...
            nextwlid = floor((nextwl+1)/deltawl)+1;
