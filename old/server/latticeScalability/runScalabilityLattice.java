...
public class runScalabilityLattice {

	
	PrismConnectorAPI myPrismConnectorAPI;
	
	public runScalabilityLattice () throws PrismException {
	...
	public static void main (String[] args) throws Exception {
		...
		String latticeFolder = "/data2/mcleav/latticeScalability/latticeModels/N" + N + "H" + H + "L" + L + "d" + d + "/nonbobLattice/";
		...
		for(int i=0;i<initDistanceValues.length;i++) {
			for(int j=0;j<initSpeedValues.length;j++) {
				...
				String myModelName = "LatticeScalabilityN" + N + "H" + H + "L" + L + "d" + d + "_initd" + initDist + ".000000_initv" + initSpeed + ".000000.prism";
        ...
        String runTimeResults = resultsFolder + "extraPointsrunTimesLatticeN" + N + "H" + H + "L" + L + "d" + d + ".csv";
        PrintWriter runTimeWriter = new PrintWriter(runTimeResults);
        
        String crashProbResults = resultsFolder + "extraPointscrashProbsLatticeN" + N + "H" + H + "L" + L + "d" + d + ".csv";
