function [lattice] = addLatticeTransitionsBundledK(lattice,N,deltad,deltav,B1,B2,fmu,amax,Thd,xThresh,TTCThresh,freq,safetyThresh)
...
%         newMapValue = zeros(N+1,2);
        for K=0:2:N
            ...
            if(K~=N)
                [nextdsNextK,nextvsNextK] = computeLatticeTransition(d,v,N,K+1,deltad,deltav,B1,B2,fmu,amax,Thd,xThresh,TTCThresh,freq,safetyThresh);
            end
            nextds = [nextds; nextdsNextK];
            nextvs = [nextvs; nextvsNextK];
