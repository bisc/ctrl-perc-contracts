...
% convertOlegBaselineToPRISMModelMultiTank(lattice,N,'PRISMModels/testModel2TankTrimmed_2_10.prism',deltawl,trimmed,2);
...
convertOlegBaselineToPRISMModelMultiTank(lattice,N,'PRISMModels/oneTankBaseline.prism',deltawl,trimmed,1);
