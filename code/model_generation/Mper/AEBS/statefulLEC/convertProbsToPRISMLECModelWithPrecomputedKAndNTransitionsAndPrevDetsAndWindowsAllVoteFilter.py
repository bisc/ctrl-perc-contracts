...
latticeDistDiscs = [1,1.25,1.5,1.75,2]
...
for latticeDistDisc in latticeDistDiscs:
    ...
    modelfile = open('latticeWindowedModels/windowedLatticeAllVoteFilter-N' + str(N) + 'M' + str(M) + 'L' + str(L) + '-deltaD' + str(latticeDistDisc) + '.prism', 'w')
    # distIndUpper = 43
    # distIndLower = 43
    LECModelDistDisc = 10
    ...
    for binInd in range(len(probsHists)):
        ...
        for prevSIter in range(0,2**lookBackLen):
            ...
            if(lookBackLen==7):
                fileName = 'windowed/k-l-m-all/N' + str(N) + 'M' + str(M) + '/probsHot-N' + str(N) + '-M' + str(M) + '-L' + str(3) + '-init' + str(1-s7) + str(1-s6) + str(1-s5) + str(1-s4) + str(1-s3) + str(1-s2) + str(1-s1) + '.csv'
            if(lookBackLen==5):
                fileName = 'windowed/k-l-m-all/N' + str(N) + 'M' + str(M) + '/probsHot-N' + str(N) + '-M' + str(M) + '-L' + str(3) + '-init' + str(1-s5) + str(1-s4) + str(1-s3) + str(1-s2) + str(1-s1) + '.csv'
            if(lookBackLen==3):
                fileName = 'windowed/k-l-m-all/N' + str(N) + 'M' + str(M) + '/probsHot-N' + str(N) + '-M' + str(M) + '-L' + str(3) + '-init' + str(1-s3) + str(1-s2) + str(1-s1) + '.csv'
            if(lookBackLen==4):
                fileName = 'windowed/k-l-m-all/N' + str(N) + 'M' + str(M) + '/probsHot-N' + str(N) + '-M' + str(M) + '-L' + str(3) + '-init' + str(1-s4) + str(1-s3) + str(1-s2) + str(1-s1) + '.csv'
            if(lookBackLen==2):
                fileName = 'windowed/k-l-m-all/N' + str(N) + 'M' + str(M) + '/probsHot-N' + str(N) + '-M' + str(M) + '-L' + str(3) + '-init' + str(1-s3) + str(1-s2) + str(1-s1) + '.csv'
                ...
                for row in csv_reader:
                    ...
                    for col in row:
                        ...
                        if(rowiter==Nmax and coliter==colIterMax):
                            if(not detProb==0):
                                if(lookBackLen==5):
                                    modelLine = "+" + str(detProb) + ":(currN'=1)&(currK'=" + str(rowiter) + ")&(s'=" + str(s1Next) + ")&(s2'=" + str(s2Next) + ")&(s3'=" + str(s3Next) + ")&(s4'=" + str(s4Next) + ")&(s5'=" + str(s5Next) + ");\n"
                                if(lookBackLen==7):
                                    modelLine = "+" + str(detProb) + ":(currN'=1)&(currK'=" + str(rowiter) + ")&(s'=" + str(s1Next) + ")&(s2'=" + str(s2Next) + ")&(s3'=" + str(s3Next) + ")&(s4'=" + str(s4Next) + ")&(s5'=" + str(s5Next) + ")&(s6'=" + str(s6Next) + ")&(s7'=" + str(s7Next) + ");\n"
                                if(lookBackLen==3):
                                    modelLine = "+" + str(detProb) + ":(currN'=1)&(currK'=" + str(rowiter) + ")&(s'=" + str(s1Next) + ")&(s2'=" + str(s2Next) + ")&(s3'=" + str(s3Next) + ");\n"
                                if(lookBackLen==4):
                                    modelLine = "+" + str(detProb) + ":(currN'=1)&(currK'=" + str(rowiter) + ")&(s'=" + str(s1Next) + ")&(s2'=" + str(s2Next) + ")&(s3'=" + str(s3Next) + ")&(s4'=" + str(s4Next) + ");\n"
                                if(lookBackLen==2):
                                    modelLine = "+" + str(detProb) + ":(currN'=1)&(currK'=" + str(rowiter) + ")&(s'=" + str(s1Next) + ")&(s2'=" + str(s2Next) + ");\n"
