...
public class runWaterTank3Ex {

	
	PrismConnectorAPI myPrismConnectorAPI;
	
	public runWaterTank3Ex () throws PrismException {
	...
	public static void main (String[] args) throws Exception {
		...
		for(int i=0;i<initWaterLevels1.length;i++) {
			...
			for(int j=0;j<=i;j++) {
				...
				String myModelName = "3TankEx.prism";
                ...
                int tempInitWaterLevel3 = (int) initWaterLevels1[j];
				String mypolicy = "";
				String consts = "wl1Init=" + (tempInitWaterLevel1) + ",wl2Init=" + (tempInitWaterLevel2) + ",wl3Init=" + (tempInitWaterLevel3)+ ",cont1State=" + (cont1State) + ",cont2State=" + (cont2State) + ",cont3State=" + (cont3State);
