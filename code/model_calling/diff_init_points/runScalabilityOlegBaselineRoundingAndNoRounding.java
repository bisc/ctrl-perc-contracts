...
public class runScalabilityOlegBaselineRoundingAndNoRounding {

	
	PrismConnectorAPI myPrismConnectorAPI;
	
	public runScalabilityOlegBaselineRoundingAndNoRounding () throws PrismException {
	...
	public static void main (String[] args) throws Exception {
		...
		String NithRoundingFolder = "/data2/mcleav/latticeScalability/olegModels/roundingConservatismTest/noRounding/";
		...
		for(int i=0;i<initDistanceValues.length;i++) {
			for(int j=0;j<initSpeedValues.length;j++) {
				...
				String myModelName = "olegBaselineAEBS_initd" + initDist + ".000000_initv" + initSpeed + ".000000.prism";
        ...
        String runTimeResults = resultsFolder + "extraExtraPointsrunTimesOlegBaselineNoRounding.csv";
        PrintWriter runTimeWriter = new PrintWriter(runTimeResults);
        
        String crashProbResults = resultsFolder + "extraExtraPointscrashOlegBaselineNoRounding.csv";
