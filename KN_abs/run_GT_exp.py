...
# python run_GT_exp.py -start_exp 1 -end_exp 7 -m 3 -init_v 200 -init_pos 1600  
#######################################################################################################
...
def run(args):
    ...
    for exp in range(start_exp,end_exp+1):
        ...
        folder_name = 'ramneet_automated_exp_results/GT/pos{}_v{}_m{}'.format(init_pos,init_v,m)
