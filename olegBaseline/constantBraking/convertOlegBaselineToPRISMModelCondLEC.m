function [] = convertOlegBaselineToPRISMModel(lattice, maxN, fileName,deltad,deltav,amax,trimmed,safetyThresh)
...
fprintf(fid, '    s : [0..1] init 0;\n');
fprintf(fid, '    s2 : [0..1] init 0;\n');
fprintf(fid, '    s3 : [0..1] init 0;\n');
fprintf(fid, '    s4 : [0..1] init 0;\n');
