...
latticeDistDiscs = [0.25, 0.5,1,1.25,1.5,1.75,2]
# latticeDistDiscs = [0.25, 0.5]
...
for latticeDistDisc in latticeDistDiscs:
    ...
    modelfile = open('latticeWindowedModels/windowedBoBLatticeAllVoteFilter-N' + str(N) + 'M' + str(M) + 'L' + str(L) + '-deltaD' + str(latticeDistDisc) + '.prism', 'w')
    # distIndUpper = 43
    # distIndLower = 43
    LECModelDistDisc = 10
    ...
    for binInd in range(len(probsHists)):
        ...
        for prevSIter in range(0,2**lookBackLen):
            ...
            if(lookBackLen==7):
                fileName = 'windowed/k-l-m-bob2-all/N' + str(N) + 'M' + str(M) + '/probsBoB-N' + str(N) + '-M' + str(M) + '-L' + str(3) + '-init' + str(1-s7) + str(1-s6) + str(1-s5) + str(1-s4) + str(1-s3) + str(1-s2) + str(1-s1) + '.csv'
            if(lookBackLen==5):
                fileName = 'windowed/k-l-m-bob2-all/N' + str(N) + 'M' + str(M) + '/probsBoB-N' + str(N) + '-M' + str(M) + '-L' + str(3) + '-init' + str(1-s5) + str(1-s4) + str(1-s3) + str(1-s2) + str(1-s1) + '.csv'
            if(lookBackLen==3):
                fileName = 'windowed/k-l-m-bob2-all/N' + str(N) + 'M' + str(M) + '/probsBoB-N' + str(N) + '-M' + str(M) + '-L' + str(3) + '-init' + str(1-s3) + str(1-s2) + str(1-s1) + '.csv'
            if(lookBackLen==4):
                fileName = 'windowed/k-l-m-bob2-all/N' + str(N) + 'M' + str(M) + '/probsBoB-N' + str(N) + '-M' + str(M) + '-L' + str(3) + '-init' + str(1-s4) + str(1-s3) + str(1-s2) + str(1-s1) + '.csv'
            if(lookBackLen==2):
                fileName = 'windowed/k-l-m-bob2-all/N' + str(N) + 'M' + str(M) + '/probsBoB-N' + str(N) + '-M' + str(M) + '-L' + str(3) + '-init' + str(1-s3) + str(1-s2) + str(1-s1) + '.csv'
