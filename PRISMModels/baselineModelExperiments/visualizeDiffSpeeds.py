...
resultsFile = open('C:\\Users\\matth\\Documents\\Penn\\safetyContract\\PRISM\\baselineModelExperiments\\windowed\\diffDistDiscsNew\\diffSpeedsTestingH3L3DistDisc05.csv')
...
plt.ylabel('P(crash)')
plt.title('PRISM Runtime v. Speed on Baseline H3L3 DistDisc0.5')
plt.show()
