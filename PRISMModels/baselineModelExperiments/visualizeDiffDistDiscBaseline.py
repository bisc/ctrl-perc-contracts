...
resultsFile = open('C:\\Users\\matth\\Documents\\Penn\\safetyContract\\PRISM\\baselineModelExperiments\\diffDistDiscresults.csv')
...
plt.ylabel('P(crash)')
plt.title('PRISM Runtime v. Probability of Crashing for Different Abstraction LEC Bundles')
# plt.show()
...
resultsFile = open('C:\\Users\\matth\\Documents\\Penn\\safetyContract\\lattice\\matlabCode\\simpleExample\\PRISMModels\\ForPaper\\diffDeltaDs\\TTCThresh\\results.csv')
csv_reader_probs_array = csv.reader(resultsFile, delimiter=',')
firstIterFlag=True
for row in csv_reader_probs_array:
    if(firstIterFlag):
